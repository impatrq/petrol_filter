# -*- coding: utf-8 -*-
#este algoritmo lo que hace es acumular N valores recientes, descarta picos y calcula el promedio de las mediciones restantes
#evitando que las lecturas del sensor fluctuen por el rebote con el agua
